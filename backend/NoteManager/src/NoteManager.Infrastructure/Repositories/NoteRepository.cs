...
internal class NoteEntityRepository : EntityRepository<Note>, INoteRepository
{
    ...
    public async Task<PagingResult<Note>> GetEntityPageAsync(int skip, int take)
    {
    ...
    public async Task<PagingResult<Note>> GetEntityPageByExpressionAsync(
